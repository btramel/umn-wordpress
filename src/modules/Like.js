...
class Like {
  ...
  ourClickDispatcher(e) {
    ...
    // flexible JS, targeting closest like box
  ...
  async createLike(currentLikeBox) {
    try {
      const response = await axios.post(hogwartsData.root_url + "/wp-json/hogwarts/v1/manageLike", { "professorId": currentLikeBox.getAttribute("data-professor") })
