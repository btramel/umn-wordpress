    ...
    while(have_posts()){
        ...
        <div class="container container--narrow page-section">
            ...
            <div class="create-note">
                ...
                <span class="note-limit-message">Note limit reached: delete an existing one to add another.</span>
            </div>
            <ul class="min-list link-list" id="my-notes">
                <?php
                    // assigns user notes info, including user ID, to a variable
                    ...
                    // while loop that displays EVERY note
